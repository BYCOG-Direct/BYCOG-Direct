...
const Testimonials = () => {
    return (
        <div className='bg-tan w-full pb-24'>
            <div className='text-center py-4 text-4xl font-semibold'>Testimonials</div>
            <section class="my-3 mx-auto max-w-6xl columns-1 md:columns-2 lg:columns-3">
                <article class="overflow-hidden mb-5 px-8 pt-6 pb-8 rounded-lg bg-white text-grey-medium shadow-xl">
                    <div class="flex mb-4">
