...
const Nav = () => {
    ...
    return (
        <div className={color ? "duration-500 bg-darkGray fixed flex justify-center gap-2 items-center py-3 px-3 right-20 top-7 z-20 rounded-full" : "duration-150 bg-gray shadow-xl fixed flex justify-center gap-2 items-center py-3 px-3 right-20 top-5 z-20 rounded-full"}>
