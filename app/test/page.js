...
export function SliderCustomStyles({ id, name, setResponses, responses }) {
            ...
            <div className="flex flex-row justify-center content-center">
                ...
                {currentSet === 1 && (
                    ...
                    <div id="flex flex-col justify-evenly content-center flex-nowrap w-[calc(32rem+1/6)]">
                        ...
                        <div className="flex flex-row justify-center content-center">
                            ...
                            <button onClick={() => { handleNextSet(); scrollToTop(); }}>Next</button>
                        </div>
                    </div>
                )}
                ...
                {currentSet === 2 && (
                    ...
                    <div id="flex flex-col justify-evenly content-center flex-nowrap w-[calc(32rem+1/6)]"> 
                        ...
                        <hr class="h-px my-7 border-0 bg-black"></hr>
                        <div className="flex flex-row justify-center content-center">
                            <button onClick={() => { handlePreviousSet(); scrollToTop(); }}>Back</button>
                            <button onClick={() => { handleNextSet(); scrollToTop(); }}>Next</button>
                        </div>
                    </div>
                )}
