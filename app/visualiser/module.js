    ...
    <div className="container bg-white w-[500px] h-full rounded-[50px] relative flex justify-evenly items-center flex-col flex-wrap" id="container1">
        ...
        <div className="relative flex items-center justify-center mb-5 options flew-row">
            <div className="leftModule w-[150px] text-right">
                <label htmlFor={`identifierModule-${index}`} className='text-[17px] mr-3'>Identifier</label>
            ...
            <div className="rightModule w-[150px] text-left pl-2 ml-2 border-l-[2px]">
                ...
                <label htmlFor={`evaluatorModule-${index}`} className='text-[17px] ml-3'>Evaluator</label>
                <br/>
                <br/>
                <input className={checkboxStyle} type="checkbox" id={`othersModule-${index}`} data-check="othersModule" data-uncheck="selfModule" checked={type.othersModule} onChange={handleCheckboxChange}/>
                <label htmlFor={`othersModule-${index}`} className='text-[17px] ml-3'>Tribe</label>
                <br/>
        ...
        <div className="relative flex items-center justify-center mb-5 options flew-row">
            ...
            <div className="rightModule w-[150px] text-left pl-2 ml-2 border-l-[2px] text-[#5161F2]">
                <input className={purpleCheckboxStyle} type="checkbox" id={`solidOthersModule-${index}`} data-check="solidOthersModule" data-uncheck="solidSelfModule" checked={type.solidOthersModule} onChange={handleCheckboxChange}/>
                <label htmlFor={`solidOthersModule-${index}`} className='text-[17px] ml-3 text-[#5161F2]'>Solid Tribe</label>
                <br/>
