    ...
    <div className="container bg-white w-[500px] h-full rounded-[50px] relative flex justify-evenly items-center flex-col flex-wrap" id="container1">
        ...
        <div className="options flex justify-center items-center flew-row relative mb-5">
            <div className="leftModule w-[150px] text-right">
                ...
                <input className={checkboxStyle} type="checkbox" id="selfModule" data-uncheck="othersModule" checked={type.selfModule} onChange={handleCheckboxChange}/>
                <br/>
                <label htmlFor="knownModule" className='text-[17px] mr-3'>Known</label>
                <input className={checkboxStyle} type="checkbox" id="knownModule" data-uncheck="newsModule" checked={type.knownModule} onChange={handleCheckboxChange}/>
                <br/>
                <br/>
                <label htmlFor="valueModule" className='text-[17px] mr-3'>Value</label>
                <input className={checkboxStyle} type="checkbox" id="valueModule" data-uncheck="reasonModule" checked={type.valueModule} onChange={handleCheckboxChange}/>
                <br/>
                <label htmlFor="abstractModule" className='text-[17px] mr-3'>Abstract</label>
                <input className={checkboxStyle} type="checkbox" id="abstractModule" data-uncheck="concreteModule" checked={type.abstractModule} onChange={handleCheckboxChange}/>
                <br/>
                <br/>
                <label htmlFor="intermediateModule" className='text-[17px] mr-3'>Intermediate</label>
                <input className={checkboxStyle} type="checkbox" id="intermediateModule" data-uncheck="extremeModule" checked={type.intermediateModule} onChange={handleCheckboxChange}/>
                <br/>
                <label htmlFor="developerModule" className='text-[17px] mr-3'>Developer</label>
                <input className={checkboxStyle} type="checkbox" id="developerModule" data-uncheck="navigatorModule" checked={type.developerModule} onChange={handleCheckboxChange}/>
            </div>
            ...
            <div className="rightModule w-[150px] text-left pl-2 ml-2 border-l-[2px]">
                ...
                <br/>
                <br/>
                <input className={checkboxStyle} type="checkbox" id="reasonModule" data-uncheck="valueModule" checked={type.reasonModule} onChange={handleCheckboxChange}/>
                <label htmlFor="reasonModule" className='text-[17px] ml-3'>Reason</label>
                <br/>
                <input className={checkboxStyle}type="checkbox" id="concreteModule" data-uncheck="abstractModule" checked={type.concreteModule} onChange={handleCheckboxChange}/>
                <label htmlFor="concreteModule" className='text-[17px] ml-3'>Concrete</label>
                <br/>
                <br/>
                <input className={checkboxStyle} type="checkbox" id="extremeModule" data-uncheck="intermediateModule" checked={type.extremeModule} onChange={handleCheckboxChange}/>
                <label htmlFor="extremeModule" className='text-[17px] ml-3'>Extreme</label>
                <br/>
                <input className={checkboxStyle} type="checkbox" id="navigatorModule" data-uncheck="developerModule" checked={type.navigatorModule} onChange={handleCheckboxChange}/>
