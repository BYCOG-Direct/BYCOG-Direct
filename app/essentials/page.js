    ...
    return (
        <main>
            ...
            <div className="header">
                ...
                <div></div>
                <p className="header-label">Essentials</p>
            </div>
            ...
            <div className="pageAlignCenter">
                <div className="pageAlignVerticle">
                    ...
                    <div className="pageAlignCenter">
                        ...
                        <div className="pageAlignVerticle">
                            <div className="pageAlignCenter">
                                <p className="paragraphRepublican"> 
                                    1st
                                </p>
                            </div>
                            <div className="lines"> </div>
            ...
            {/* <!-- MODULES --> */}
            <div className="pageAlignCenterModules">
                <div id="standard_text">
                    <p></p>
                    <p className="titleText">
                        THE MODULES
            ...
            <div>
                <div className="pageAlignCenterModules wrapThis moduleBoxes">
                    <div className="wordBoxes2">  
                        <p className="titleTextBox">
                        ...
                        <p></p>
                        <div className="pageAlignCenter">
                            <div className="wordBoxesAbstractL">
                                <div className="wordBoxes3"> 
                                    <div className="pageAlignCenter">
                            ...
                            <div className="wordBoxesConcreteR"></div>
                        </div>
                        <div><font COLOR="#323031" SIZE="4px">.</font></div>
                        <div className="pageAlignCenter">
                            <div className="wordBoxesConcreteL">
                                <div className="wordBoxes3"> 
                                    <div className="pageAlignCenter">
                                        <div className="wordBoxes4">
                                            <p className="titleTextBox">
                            ...
                            <div className="wordBoxesAbstractR"></div>
                        </div>
                    </div>
                    <div className="wordBoxes2">  
                        <p className="titleTextBox">
                        ...
                        <p></p>
                        <div className="pageAlignCenter">
                            <div className="wordBoxesReasonL">
                                <div className="wordBoxes3"> 
                                <div className="pageAlignCenter">
                                    <div className="wordBoxes4">
                                        <p className="titleTextBox">
                            ...
                            <div className="wordBoxesValueR"></div>
                        </div>
                        <div><font COLOR="#323031" SIZE="4px">.</font></div>
                        <div className="pageAlignCenter">
                            <div className="wordBoxesValueL">
                                <div className="wordBoxes3"> 
                                    <div className="pageAlignCenter">
                                        <div className="wordBoxes4">
                                            <p className="titleTextBox">
                            ...
                            <div className="wordBoxesReasonR"></div>
                        </div>
                    </div>
                </div>
            </div> 
            ...
            <div id="footer_credits_container">
                <div id="footer_credits">
                    ...
                    <Link href="https://www.objectivepersonality.com/" target="_blank">
                        Objective Personality System by D. & S. Powers.
                    </Link>
                    The demands, stances and many other factors have their concept originate from them, and for that we thank them for sharing such theory open source.
                    <p></p> 
                    ...
                    Some definitions have shifted, and may not correlate with what Jung intended. To avoid confusion they have been given new names and labels.
                    <br/>
                    <sharing 
                        title="BYCOG Direct"
